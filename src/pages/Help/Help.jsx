...
const Help = () => {
  return (
    <section id="help">
      <img src="/help/blob_01.png" alt="" className="blob-01"/>

      <img src="/help/wave.svg" alt="" />
      <div>
        <h1>Hints</h1>
      ...
      <div>
        <h1>Noun Endings</h1>
        <img src="/help/chart_01.png" alt="" />
        <p>source: <a href="#">https://germanwithlaura.com/noun-gender</a></p>
      </div>

      <div>
        <h1>Noun Groups</h1>
        <img src="/help/chart_02.png" alt="" />
        <p>source: <a href="#">https://germanwithlaura.com/noun-gender</a></p>
      </div>
      ...
      <img src="/help/blob_02.png" alt="" className="blob-02"/>
    </section>
  )
}
